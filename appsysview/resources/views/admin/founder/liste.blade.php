...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Shows liste
            <a href="{{route('newfounder')}}" class="btn btn-sm btn-primary">+</a>
            <a href="{{route('founderlstdel')}}" class="btn btn-xs btn-danger">Del</a>
        </h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            <tr  class="odd gradeX">
                                ...
                                <td width="100">{{limitemtxt($show->link,20)}}</td>

                                <td class="row visible-lg" width="100">
                                    {{$show->description}}
                                </td>
                                <td class="row visible-lg">{{statuscmd($show->status)}}</td>

                                <td>
                                    <form action="{{route('delfounder',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('editfounder',$show->id)}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i></a>
                        ...
                        @empty
                            <tr>
                                <td colspan="9"> <center><a href="{{route('addstfounder')}}">Ajouter Data Default </a></center> </td>
                            </tr>
