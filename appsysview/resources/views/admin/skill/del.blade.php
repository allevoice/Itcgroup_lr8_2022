...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Skill Delete liste
            <a href="{{route('listskill')}}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-arrow-left"></i></a>
        </h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            ...
                            @endif
                                ...
                                <td>
                                    <form action="{{route('skilldeletecomplete',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('skillrestoredele',$show->id)}}" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-transfer"></i></a>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-3 control-label">Numbre</label>
                                                        <div class="col-sm-9">
                                                            <input class="form-control" value="{{$show->numberskill}}" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input class="form-control" value="{{$show->linkskill}}" readonly>
                                                        </div>
                                                    </div>
