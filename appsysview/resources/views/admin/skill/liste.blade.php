...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Skill Shows liste
            <a href="{{route('newskill')}}" class="btn btn-sm btn-primary">+</a>
            <a href="{{route('listedelskill')}}" class="btn btn-xs btn-danger">Del</a>
        </h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            ...
                            @endif
                                ...
                                <td>
                                    <form action="{{route('delskill',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('editskill',$show->id)}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i></a>
