...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Banners liste Delete
            <a href="{{route('listslide')}}" class="btn btn-sm btn-danger"><i class="glyphicon glyphicon-arrow-left"></i></a>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            <tr  class="odd gradeX">
                                ...
                                <td width="100">
                                    <form action="{{route('slidedelete',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('restdelslide',$show->id)}}" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-transfer"></i></a>
