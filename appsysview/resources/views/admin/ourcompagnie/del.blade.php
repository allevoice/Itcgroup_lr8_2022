...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Delete liste
            <a href="{{route('listourcmg')}}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-arrow-left"></i></a>
        </h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            <tr  class="odd gradeX">
                                ...
                                <td width="100">
                                    <form action="{{route('ourcmgdelete',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('restdelourcmg',$show->id)}}" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-transfer"></i></a>
