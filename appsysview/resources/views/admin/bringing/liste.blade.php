...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Shows liste
            <a href="{{route('newbringing')}}" class="btn btn-sm btn-primary">+</a>
            <a href="{{route('bringlstdel')}}" class="btn btn-xs btn-danger">Del</a>
        </h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            <tr  class="odd gradeX">
                                ...
                                <td width="100">
                                    <form action="{{route('delbringing',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('editbringing',$show->id)}}" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i></a>
