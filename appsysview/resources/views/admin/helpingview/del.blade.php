...
@section('admincontenent')
    <div class="col-md-12">
        <h2>
            Helping Delete liste
            <a href="{{route('listhelping')}}" class="btn btn-xs btn-primary"><i class="glyphicon glyphicon-arrow-left"></i></a>
        </h2>
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        @forelse ($data as $show)
                            ...
                            @endif
                                ...
                                <td>
                                    <form action="{{route('helpingdeletecomplete',$show->id)}}" method="post" class='form-inline'>
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <a href="{{route('helpingrestoredele',$show->id)}}" class="btn btn-xs btn-warning"><i class="glyphicon glyphicon-transfer"></i></a>
